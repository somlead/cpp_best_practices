...
// configuration step. It creates a namespace called `cpp_best_practices`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_best_practices::cmake::project_name, cpp_best_practices::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_best_practices::cmake::project_version);
      return EXIT_SUCCESS;
    }
